...
if __name__ == '__main__':
    img1 = cv2.imread("/Users/weihao/Downloads/local_colmap_baseline/images/IMG_0007.png")
    img2 = cv2.imread("/Users/weihao/Downloads/local_colmap_baseline/images/IMG_0008.png")
    #img1 = cv2.imread("/Users/weihao/Downloads/GMS-Feature-Matcher-master/data/nn_left.jpg")
    #img2 = cv2.imread("/Users/weihao/Downloads/GMS-Feature-Matcher-master/data/nn_right.jpg")
    ...
    pts1 = np.array([gms.keypoints_image1[m.queryIdx].pt for m in matches])
    pts2 = np.array([gms.keypoints_image2[m.trainIdx].pt for m in matches])
    ...
    focal_length = 3225.6 / 3024.0 * 960.0
    principal_point = tuple((np.array(img1.shape[0:2]) / 2.0).astype(int))

    E, mask = cv2.findEssentialMat(pts1, pts2, focal=focal_length, pp=principal_point, prob=0.995, threshold=0.5)
    # R1, R2, t = cv2.decomposeEssentialMat(E)
    retval, R, t, mask = cv2.recoverPose(E, pts1, pts2, focal=focal_length, pp=principal_point)

    print('{}'.format(rotation_to_rph(R)))
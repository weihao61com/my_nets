...
class GoogLeNet(Network):
    def setup(self):
        ...
        (self.feed('cls3_pool',
                   'shift')
             .concat(3, name='features')
             .fc(2048, name='cls3_fc0_pose')
             .fc(100, name='cls3_fc1_pose')
        ...
        #     with tf.variable_scope(l, reuse=True):
        #         try:
        #             var = tf.get_variable("weights")
        #             print("{}:  {}".format(l, var.shape))
        #         except:
        #             continue

...
def run_colmap_seq(project_dir, key, mode, max_image, max_match_per_image=2, seq=0):

    poses_dic_all, cam = get_poses(project_dir, key, mode)

    k = poses_dic_all.keys()[seq]
    poses_dic = {k: poses_dic_all[k]}
...
if __name__ == "__main__":
    key = 'office'  #office" #heads
    mode = 'head'
    project_dir = '/home/weihao/Projects'

    run_colmap_seq(project_dir, key, mode, 2000)
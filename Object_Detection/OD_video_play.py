...
filename = '/media/weihao/DISK0/flickr_images/out.mp4'# '/home/weihao/tmp/out.mp4'
...
for ps in persons:
    ...
    for p in ps:
        if p[0] not in frame_ids:
            frame_ids[p[0]] = []
        frame_ids[p[0]].append([pid, p[1]])
    pid += 1
